...
export function ActionPanel(props: ActionPanelProps) {
	...
	return (
		<div style={{ fontFamily: "system-ui, sans-serif", color: "#111" }}>
			...
			{!supported && (
				<InfoText>Open a supported chat or project page.</InfoText>
			)}
			...
			{supported && (
				...
				>
					<ActionButton onClick={props.onExport} disabled={props.disabled}>
						Export
					</ActionButton>
					...
					{isChat && props.onClipboard && (
						<ActionButton onClick={props.onClipboard} disabled={props.disabled}>
							Clipboard
						</ActionButton>
					)}
				</div>
